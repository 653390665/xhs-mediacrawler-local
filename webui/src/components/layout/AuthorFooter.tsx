...
export function AuthorFooter() {
  ...
  return (
    <footer className="h-24 flex-shrink-0 bg-cyber-bg-panel border-t border-cyber-border-subtle">
      <div className="h-full px-6 flex items-center justify-center gap-6">
        {/* Author Avatar */}
        <div className="w-14 h-14 rounded-md overflow-hidden border border-cyber-neon-cyan/60 flex-shrink-0">
          <img
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="w-11 h-11 rounded-md flex items-center justify-center border border-cyber-border-subtle hover:border-cyber-neon-cyan transition-colors bg-cyber-bg-tertiary"
            title="GitHub"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-11 h-11 rounded-md flex items-center justify-center border border-cyber-border-subtle hover:border-cyber-neon-pink transition-colors bg-cyber-bg-tertiary"
            title="哔哩哔哩"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-11 h-11 rounded-md flex items-center justify-center border border-cyber-border-subtle hover:border-cyber-text-primary transition-colors bg-cyber-bg-tertiary"
            title="抖音"
          >
