...
async def update_xhs_note(note_item: Dict):
    ...
    local_db_item = {
        ...
        "follower_count": user_info.get("follower_count") or user_info.get("fans_count") or user_info.get("followers"),  # 作者粉丝数（对标评分校准用，非骚扰用途）
        ...
        "note_url": f"https://www.xiaohongshu.com/explore/{note_id}",  # Public note URL without access token
